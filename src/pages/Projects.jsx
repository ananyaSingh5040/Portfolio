      ...
      <div className="flex flex-col items-center gap-10">
        ...
        >
          <div className="flex flex-col md:flex-row-reverse items-center gap-6 text-left">
            {/* Image on right */}
            <img
              src="/urlProject1.png" // Replace with your actual image path
              alt="URL Shortener"
...
>
  <div className="flex flex-col md:flex-row-reverse items-center gap-6 text-left">
    {/* Image on right */}
    <img
      src="/task2.png" // Replace with your actual image path
...
>
  <div className="flex flex-col md:flex-row-reverse items-center gap-6 text-left">
    {/* Image on right */}
    <img
      src="/cherryBakes1.png" // Replace with your actual image path
